...
const EncoderApp = () => {
  ...
  const getEncoderApp = async () => {
    try {
      const { data } = await axios.get(
        `${BASE_API_URL}/encoders/encoder_apps/get_encoder_app?encoder_app_id=${id}`
      );
      setApp(data);
  ...
  const getAllNodes = async () => {
    try {
      const { data } = await axios.get(
        `${BASE_API_URL}/encoders/encoder_ontology/get_nodes?encoder_app_id=${id}&version_name=${activeVersionRight}`
      );
  ...
  const getChildrenNodes = async (code) => {
    ...
    try {
      const { data } = await axios.get(
        `${BASE_API_URL}/encoders/encoder_ontology/get_nodes?encoder_app_id=${id}&version_name=${activeVersionRight}&parent_node_code=${code}`
      );
      setExpandedNodes({
        ...expandedNodes,
        [code]: data.nodes,
  ...
  const getPredictions = async () => {
    try {
      const { data } = await axios.get(
        `${BASE_API_URL}/encoders/encoder_predictions/get_predictions?encoder_app_id=${id}&version_name=${activeVersionLeft}&term=${activeTerm}&page=${page}`
      );
      setPredictions(data);
    } catch (error) {
      console.log(error);
